	...
	return (
		<>
			...
			<p id="about-query">
				...
				можна використовувати "регулярний вираз" у такому форматі: якщо
				поле, яке ви фільтруєте, має тип string, то ви можете
				використовувати наступний шаблон:{" "}
				<code>
					<CodeString className="px-2 py-0.5 text-nowrap">
				...
				. Значення min та max можуть бути вказані (або обидва, або лише
				одне), або ви можете вказати конкретне числове значення для
				порівняння за допомогою equal.
			</p>
