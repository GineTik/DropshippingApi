			...
			<Section>
				<div className="w-full max-w-[750px] mx-auto p-2 md:p-0">
					<H2 className="text-center mb-6">
						Отримуйте товари через АПІ або ж скачуюючи файл в
						кабінеті
					</H2>
					<span className="text-center block text-sm/normal md:text-xl/8">
						Для отримання доступних товарів, створено декілька
						кінцевих точок. Надіславши запит, АПІ поверне набір
						товарів. Якщо вам потрібно отримати набір товарів
						вручну, це можна зробити у вашому кабінеті в декількох
						форматах.
					</span>
				</div>
